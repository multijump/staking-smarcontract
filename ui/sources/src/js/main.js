...
function popups() {
  $(document).on("click", ".js-popup-open", function (e) {
    ...
    if (_id == "#stake_asset") {
      $(_id).find('#stake_asset_alert').text('');
      ...
      $(_id).find("#current_pool_pair_max").val($(this).attr("data-max-amount"));
      $(_id).find("#current_pool_pair_current").val($(this).attr("data-current-staked"));
